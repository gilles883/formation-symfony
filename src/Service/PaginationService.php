...
class PaginationService
{
    ...
    public function getPages()
    {
        ...
        $pages = ceil($total / $this->limit);   // ceil(): arrondi à l'entier supérieur
    ...
    public function getData()
    {
        ...
        // 2) Demander au repository de trouver les éléments à partir d'un offset et dans la limite d'éléments imposée (voir propriété $limit)
        return $this->manager
                    ->getRepository($this->entityClass)
